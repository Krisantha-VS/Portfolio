...
import { skills, softSkills, languages } from "@/data/portfolio";
import {
  Code2,
  Database,
  Palette,
...
const skillCategories = [
  { title: "Frameworks", icon: Code2, items: skills.frameworks, color: "from-purple-500 to-pink-500" },
  ...
  { title: "Frontend & Style", icon: Palette, items: skills.frontend, color: "from-orange-500 to-red-500" },
  { title: "Libraries & Tools", icon: Code2, items: skills.libraries, color: "from-violet-500 to-purple-500" },
  { title: "Development Tools", icon: Wrench, items: skills.devTools, color: "from-yellow-500 to-orange-500" },
  { title: "Design Tools", icon: Palette, items: skills.design, color: "from-pink-500 to-rose-500" },
  { title: "Office & Collaboration", icon: Briefcase, items: skills.office, color: "from-indigo-500 to-blue-500" },
];
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
            A versatile full-stack engineer with expertise across modern web technologies
                    ...
                    >
                      ...
                      <div className="w-full bg-secondary rounded-full h-2 overflow-hidden">
                        <motion.div
                          initial={{ width: 0 }}
                          whileInView={{
                            width: lang.level === "Native" ? "100%" : "85%",
                          }}
                          viewport={{ once: true }}
